...
public class ListOptionFormat extends OptionFormat {
  ...
  private OptionFormat subFormat;
	...
	/**
	 * Override of @see org.codehaus.plexus.cling.cli.OptionFormat#isValid(java.lang.String)
	 * 
	 * @param value
	 * @return
	...
	/**
	 * Override of @see org.codehaus.plexus.cling.cli.OptionFormat#getValue(java.lang.String)
	 * 
	 * @param value
	 * @return
