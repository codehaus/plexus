    ...
    extends AbstractComponentConfigurator
{
        ...
        throws ComponentConfigurationException
    {
    	...
    	for (int i = 0; i < methods.length; i++)
    	{
    		...
    		else if ( methodName.equals( "set" ) && paramTypes.length == 2 && paramTypes[0].equals(String.class) && paramTypes[1].equals(Object.class) )
    		{
    			plainSet = methods[i];
    		}
		}
    	...
    	for ( int i = 0; i < items; i++ )
        {
            ...
            Object value = 
            	setterTypeConverter.fromConfiguration( converterLookup, childConfiguration, setterParamType, 
            			component.getClass(), containerRealm.getClassLoader(), expressionEvaluator, listener );
            ...
            if ( value != null )
            {
                ...
                try
                {
	                ...
	                try
	                {
		                ...
		                String upElementName = Character.toUpperCase( elementName.charAt(0) ) + elementName.substring( 1 );
                ...
                catch ( IllegalArgumentException e )
                {
                	throw new ComponentConfigurationException( "Invalid parameter supplied while setting '" + value + "' to " +
                			component.getClass().getName() + "." + elementName + "( " + setterParamType.getClass().getName() + " )", e );
                }
