...
public class AllPairsShortestPath
{
        ...
        implements WeightedPath
    {
            ...
            throws GraphException
        {
            ...
            vertexList.addAll( segment( vArray, pred, start, finish ) );
         ...
         * finish.
         */
        private List segment( Vertex vArray[],
                              int pred[][],
                              int start,
                              int finish )
            throws GraphException
        {
            ...
            {
                RC.addAll( segment( vArray, pred, start, mid ) );
                RC.add( vArray[mid] );
            }
            ...
            {
                RC.addAll( segment( vArray, pred, mid, finish ) );
            }
            return RC;
        }
    ...
    public WeightedPath getShortestPath( Vertex start,
        ...
        throws GraphException
    {
        return new WPath( graph, vArray, pred, index( start ), index( end ), cost[index( start )][index( end )] );
    }
