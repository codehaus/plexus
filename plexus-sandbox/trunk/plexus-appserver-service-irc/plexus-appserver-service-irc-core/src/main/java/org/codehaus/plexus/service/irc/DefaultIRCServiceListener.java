    ...
    implements IRCEventListener
{
    ...
    {
        org.codehaus.plexus.service.irc.IRCUser ircUser = new DefaultIRCUser( user );
...
*/
    ...
    private void doCommand( String target, org.codehaus.plexus.service.irc.IRCUser user, String message )
    {
    ...
    {
        manager.sendNotice( user.getNick(),
                            IRCUtil.actionIndicator + "VERSION Plexus IRC Service 1.0-SNAPSHOT - plexus.codehaus.org" );
        org.codehaus.plexus.service.irc.IRCUser ircUser = new DefaultIRCUser( user );
    ...
    {
        manager.sendNotice( user.getNick(), IRCUtil.actionIndicator + "Time " + new Date() );
        org.codehaus.plexus.service.irc.IRCUser ircUser = new DefaultIRCUser( user );
