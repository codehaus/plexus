    ...
    extends PlexusTestCase
{
    ...
    public void testStartup()
        throws Exception
    {
        IRCServiceManager ircManager = (IRCServiceManager) lookup( IRCServiceManager.class.getName() );
        ...
        throws Exception
    {
        ...
        IRCServiceManager ircManager = (IRCServiceManager) lookup( IRCServiceManager.class.getName() );
        DefaultIRCServiceListener listeners = new DefaultIRCServiceListener( ircManager );
        try
        {
