 ...
 * http://open-im.org/
 */
package org.codehaus.plexus.server.jabber.jabber.iq.vcardtemp;
 ...
 * @avalon.service type="org.codehaus.plexus.server.jabber.jabber.iq.vcardtemp.VCard"
 */
    ...
    implements VCard
{
    ...
    //-------------------------------------------------------------------------
    private void get( final IMSession session,
                      Object context )
        throws Exception
    {
    ...
    //-------------------------------------------------------------------------
    private void result( final IMSession session,
                         final Object context )
        throws Exception
    {
