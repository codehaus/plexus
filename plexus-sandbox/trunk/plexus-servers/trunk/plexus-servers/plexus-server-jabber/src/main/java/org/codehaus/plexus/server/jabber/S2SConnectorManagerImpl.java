 ...
 * @avalon.service type="org.codehaus.plexus.server.jabber.S2SConnectorManager"
 */
    ...
    implements S2SConnectorManager, Initializable, Serviceable
{
    ...
    /**
     * @avalon.dependency type="org.codehaus.plexus.server.jabber.S2SConnector:1.0"  key="S2SConnector"
        ...
        throws Exception
    {
        ...
        {
            throw new Exception(
                "Unable to get dialback validation for " + hostname + " after timeout " + timeout + " ms" );
        }
