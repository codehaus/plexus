 ...
 * @avalon.service type="org.codehaus.plexus.server.jabber.IMConnectionHandler"
 */
    ...
    implements IMConnectionHandler, ConnectionHandler, Configurable, Disposable
{
    ...
    /**
     * @avalon.dependency type="org.codehaus.plexus.server.jabber.jabber.Streams:1.0" key="Streams"
     * @avalon.dependency type="org.codehaus.plexus.server.jabber.jabber.FlashStreams:1.0" key="FlashStreams"
     ...
     * @avalon.dependency type="org.codehaus.plexus.server.jabber.S2SConnectorManager:1.0" key="S2SConnectorManager"
     */
        ...
        throws java.io.IOException, java.net.ProtocolException
    {
        ...
        try
        {
            ...
            getLogger().debug(
                "######## [" + m_serverParameters.getHostName() + "] New session instance: " + session.getId() );
