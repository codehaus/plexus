 ...
 * @avalon.service type="org.codehaus.plexus.server.jabber.session.IMClientSession"
 */
    ...
    implements IMClientSession, Initializable, Serviceable, Configurable
{
    ...
    /**
     * @avalon.dependency type="org.codehaus.plexus.server.jabber.ServerParameters"  key="ServerParameters"
     * @avalon.dependency type="org.codehaus.plexus.server.jabber.data.UsersManager"  key="UsersManager"
     * @avalon.dependency type="org.codehaus.plexus.server.jabber.IMPresenceHolder"  key="IMPresenceHolder"
     */
