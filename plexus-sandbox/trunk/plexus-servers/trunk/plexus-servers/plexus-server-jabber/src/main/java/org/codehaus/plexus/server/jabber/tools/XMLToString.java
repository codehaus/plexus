 ...
 * http://open-im.org/
 */
package org.codehaus.plexus.server.jabber.tools;
...
public class XMLToString
{
    ...
    public void addFilledAttribut( String name,
                                   String value )
    {
    ...
    public StringBuffer toStringBuffer()
    {
        ...
        if ( m_innerBuffer != null )
        {
            buffer.append( m_buffer ).append( '>' ).append( m_innerBuffer ).append( "</" ).append(
                m_elementName ).append( '>' );
        }
        else
        {
