 ...
 * @author AlAg
 * @version 1.0
 * @avalon.component version="1.0" name="org.codehaus.plexus.server.jabber.IMServer" lifestyle="transient"
 * @avalon.service type="org.codehaus.plexus.server.jabber.IMServer"
 */
    ...
    implements IMServer, Configurable, Initializable, ConnectionHandlerFactory, Serviceable, Disposable
{
        ...
        throws java.lang.Exception
    {
        ...
        final ServerSocket clientServerSocket =
            factory.createServerSocket( m_serverParameters.getLocalClientPort(), m_listenBacklog, m_bindTo );
        final ServerSocket serverServerSocket =
            factory.createServerSocket( m_serverParameters.getLocalServerPort(), m_listenBacklog, m_bindTo );
        ...
        final ServerSocket sslClientServerSocket =
            sslfactory.createServerSocket( m_serverParameters.getLocalSSLClientPort(), m_listenBacklog, m_bindTo );
        final ServerSocket sslServerServerSocket =
            sslfactory.createServerSocket( m_serverParameters.getLocalSSLServerPort(), m_listenBacklog, m_bindTo );
        ...
        String s = "Server '" + m_serverParameters.getHostName() + "' initialized on" + " server2server port " +
            m_serverParameters.getLocalServerPort() + " SSL-server2server port " +
            m_serverParameters.getLocalSSLServerPort() + " client2server port " +
            m_serverParameters.getLocalClientPort() + " SSL-client2server port " +
            m_serverParameters.getLocalSSLClientPort();
    ...
    class DisposedConnectionHandler
