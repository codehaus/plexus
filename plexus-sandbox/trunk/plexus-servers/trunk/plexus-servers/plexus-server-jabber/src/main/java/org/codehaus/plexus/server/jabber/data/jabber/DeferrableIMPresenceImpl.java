...
import org.codehaus.plexus.server.jabber.tools.XMLToString;
    ...
    implements IMPresence, Deferrable, java.io.Serializable
{
    ...
    public DeferrableIMPresenceImpl( IMPresence presence )
    {
        ...
        m_to = presence.getTo();
        m_from = presence.getFrom();

        m_type = presence.getType();
        m_show = presence.getShow();
        m_priority = presence.getPriority();
        m_status = presence.getStatus();
