 ...
 * @avalon.service type="org.codehaus.plexus.server.jabber.jabber.iq.roster.Query"
 */
    ...
    implements Query
{
    ...
    /**
     * @avalon.dependency type="org.codehaus.plexus.server.jabber.jabber.iq.roster.Item:1.0" key="iq.roster.Item"
    ...
    // ------------------------------------------------------------------------
    private void set( String iqId,
                      IMClientSession session )
        throws Exception
    {
    ...
    // ------------------------------------------------------------------------
    private final void emitToAllRegisteredSession( IMClientSession session,
                                                   String str )
        throws Exception
    {
