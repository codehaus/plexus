    ...
    implements SubscriptionManager, Serviceable
{
    ...
    // ------------------------------------------------------------------------
    private void preSubscribe( IMSession session,
                               IMPresence presence,
                               boolean toLocalHost )
        throws Exception
    {
    ...
    // ------------------------------------------------------------------------
    private void postSubscribe( IMSession session,
                                IMPresence presence )
        throws Exception
    {
        String to = presence.getTo();
    ...
    private void preSubscribed( IMSession session,
                                IMPresence presence,
                                boolean toLocalHost )
        throws Exception
    {
    ...
    // ------------------------------------------------------------------------
    private void postSubscribed( IMSession session,
                                 IMPresence presence )
        throws Exception
    {
    ...
    private void preUnsubscribe( IMSession session,
                                 IMPresence presence,
                                 boolean toLocalHost )
        throws Exception
    {
    ...
    // ------------------------------------------------------------------------
    private void postUnsubscribe( IMSession session,
                                  IMPresence presence )
        throws Exception
    {
        session.getRouter().route( session, presence );
    ...
    private void preUnsubscribed( IMSession session,
                                  IMPresence presence,
                                  boolean toLocalHost )
        throws Exception
    {
    ...
    // ------------------------------------------------------------------------
    private void postUnsubscribed( IMSession session,
                                   IMPresence presence )
        throws Exception
    {
    ...
    private final void addRoster( String usernameJID,
                                  IMRosterItem roster )
    {
    ...
    // ------------------------------------------------------------------------
    private final void setRosterSubcription( String usernameJID,
                                             String itemJID,
                                             String subscription )
    {
    ...
    // ------------------------------------------------------------------------
    private final void removeRoster( String usernameJID,
                                     String itemJID )
    {
        String username = JIDParser.getName( usernameJID );
        List rosterList = m_rosterListReposityHolder.getRosterList( username );
    ...
    // ------------------------------------------------------------------------
    private final IMRosterItem getRoster( String usernameJID,
                                          String itemJID )
    {
        String username = JIDParser.getName( usernameJID );
        List rosterList = m_rosterListReposityHolder.getRosterList( username );
    ...
    // ------------------------------------------------------------------------
    private final void removeFromRosterList( List rosterList,
                                             String jid )
    {
    ...
    // ------------------------------------------------------------------------
    private final IMRosterItem getItemFromRosterList( String jid,
                                                      List rosterList )
    {
    ...
    // ------------------------------------------------------------------------
    private final void emitToAllRegisteredSession( IMSession session,
                                                   String usernameJID,
                                                   String str )
        throws Exception
    {
