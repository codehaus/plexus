...
public class Whois extends Command
{
    ...
    public Message[] exec( org.codehaus.plexus.server.irc.user.User user )
    {
        ...
        if ( toTokens != null )
        {
            ...
            for ( int i = 0; i < toTokens.length; i++ )
            {
                ...
                org.codehaus.plexus.server.irc.user.User userToIdentify = null;
                try
                {
     ...
     */
    private void identifyUser( Vector vCurrentMessages, org.codehaus.plexus.server.irc.user.User user, org.codehaus.plexus.server.irc.user.User userToIdentify )
    {
