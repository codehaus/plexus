    ...
    implements Cloneable, Serializable
{
    ...
    public void addEdge( final Vertex from,
                         final Vertex to )
        throws CycleDetectedException
    {
    ...
    public void removeEdge( final String from,
                            final String to )
    {
        final Vertex v1 = addVertex( from );
    ...
    public void removeEdge( final Vertex from,
                            final Vertex to )
    {
    ...
    public boolean hasEdge( final String label1,
                            final String label2 )
    {
