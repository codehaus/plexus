...
public class URLCodec
{
    ...
    protected String charset = ENCODING_UTF_8;
        ...
        throws UnsupportedEncodingException
    {
        ...
        return new String( encode( pString.getBytes( charset ) ), ENCODING_US_ASCII );
    }
        ...
        throws CodecException, UnsupportedEncodingException
    {
        ...
        return new String( decode( pString.getBytes( ENCODING_US_ASCII ) ), charset );
    }
     ...
     * @throws EncoderException Thrown if URL encoding is not applicable to objects of this
        ...
        throws CodecException
    {
        ...
        {
            throw new CodecException( "Objects of type " + pObject.getClass().getName() + " cannot be URL encoded" );
     ...
     * @throws CodecException Thrown if URL decoding is not applicable to objects of this
        ...
        throws CodecException
    {
        ...
        {
            throw new CodecException( "Objects of type " + pObject.getClass().getName() + " cannot be URL decoded" );
