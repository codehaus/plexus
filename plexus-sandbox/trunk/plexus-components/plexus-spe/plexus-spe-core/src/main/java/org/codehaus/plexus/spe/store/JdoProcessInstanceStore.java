 ...
 * @version $Id$
 */
public abstract class JdoProcessInstanceStore
    ...
    implements ProcessInstanceStore, Initializable
{
        ...
        throws ProcessException
    {
        ...
        ProcessInstance instance = new ProcessInstance( null, ProcessDescriptor.getId() );
    ...
    public synchronized Collection<? extends ProcessInstance> getActiveInstances()
    {
        ...
        try
        {
            ...
            Collection<ProcessInstance> collection = pm.detachCopyAll( (Collection) query.execute() );
