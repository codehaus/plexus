    ...
    extends PlexusTestCase
{
    ...
    /**
     * Invoke a soap with the specified document.
     *
     * @param service  The name of the soap.
     * @param document The request as an xml document in the classpath.
     */
    protected Document invokeService( String service,
                                      String document )
        throws Exception
    {
        ...
        throws Exception
    {
        if ( factory == null )
        {
            ObjectServiceFactory ofactory =
                new ObjectServiceFactory( getXFire().getTransportManager(), new MessageBindingProvider() );
