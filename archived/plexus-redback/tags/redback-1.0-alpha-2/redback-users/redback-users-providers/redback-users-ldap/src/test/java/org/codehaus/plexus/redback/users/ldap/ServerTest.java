...
public class ServerTest extends AbstractServerTest
{
    ...
    private DirContext createContext( String partition ) throws NamingException
    {
        ...
        Hashtable env = 
            new Hashtable( configuration.toJndiEnvironment() );
    ...
    {
        // Searching for all
        Set result = searchDNs( "(ObjectClass=*)", "o=sevenSeas", "", 
     ...
     */
    private Set searchDNs( String filter, String partition, String base, int scope ) 
