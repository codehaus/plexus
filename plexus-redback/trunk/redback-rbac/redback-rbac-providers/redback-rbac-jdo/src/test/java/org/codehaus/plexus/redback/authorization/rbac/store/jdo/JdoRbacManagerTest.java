...
import org.codehaus.plexus.redback.authorization.store.test.AbstractRbacManagerTestCase;
    ...
    extends AbstractRbacManagerTestCase
{
        ...
        throws Exception
    {
        ...
        URL jdoFileUrls[] = new URL[] { getClass()
            .getResource( "/org.codehaus.plexus.redback/authorization/rbac/jdo/package.jdo" ) }; //$NON-NLS-1$
