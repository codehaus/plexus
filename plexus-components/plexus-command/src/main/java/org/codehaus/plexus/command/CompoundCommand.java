 ...
 * </copyright>
 *
 * plugins/org.codehaus.emf.common/src/org/codehaus/emf/common/command/CompoundCommand.java, emf.common, org.codehaus.dev, 20030620_1105VL
 * @version 1.7 6/20/03
 */
...
public class CompoundCommand extends AbstractCommand
{
    ...
    public String getDescription()
    {
        ...
        {
            return "CompoundCommand description";
        }
        else if ( resultIndex == LAST_COMMAND_ALL || resultIndex == MERGE_COMMAND_ALL )
        {
     ...
     * if <code>command.{@link org.codehaus.plexus.command.Command#canExecute() canExecute()}</code> returns true;
     * otherwise, it simply calls <code>command.{@link org.codehaus.plexus.command.Command#dispose() dispose()}</code>
     ...
     * {@link org.codehaus.plexus.command.UnexecutableCommand#INSTANCE}, if there are no commands,
