...
public interface PlexusCipher
{
    ...
    /**
     * encrypt given string with the given passPhrase 
	...
	/**
     * encrypt given string with the given passPhrase, encode it into base64
     * and return result, wrapped into { } decorations 
     * 
	 * @param str
	 * @param passPhrase
	 * @return
